...
AVALAIBLE_BUNDLES = {
    ...
    'foundation6_js': Bundle(
        ...
        'js/foundation6/foundation/plugins/foundation.util.imageLoader.js',
        ...
        'js/foundation6/foundation/plugins/foundation.responsiveAccordionTabs.js',
